...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/parandor/samples/internal/gen/tests/go/samples/train_ticketing/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TrainTicketingServiceName = "tests.go.samples.train_ticketing.v1.TrainTicketingService"
)
...
const (
	...
	TrainTicketingServicePurchaseTicketProcedure = "/tests.go.samples.train_ticketing.v1.TrainTicketingService/PurchaseTicket"
	// TrainTicketingServiceViewReceiptProcedure is the fully-qualified name of the
	// TrainTicketingService's ViewReceipt RPC.
	TrainTicketingServiceViewReceiptProcedure = "/tests.go.samples.train_ticketing.v1.TrainTicketingService/ViewReceipt"
	...
	TrainTicketingServiceViewAdminDetailsProcedure = "/tests.go.samples.train_ticketing.v1.TrainTicketingService/ViewAdminDetails"
	// TrainTicketingServiceRemoveUserProcedure is the fully-qualified name of the
	// TrainTicketingService's RemoveUser RPC.
	TrainTicketingServiceRemoveUserProcedure = "/tests.go.samples.train_ticketing.v1.TrainTicketingService/RemoveUser"
	// TrainTicketingServiceModifySeatProcedure is the fully-qualified name of the
	// TrainTicketingService's ModifySeat RPC.
	TrainTicketingServiceModifySeatProcedure = "/tests.go.samples.train_ticketing.v1.TrainTicketingService/ModifySeat"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	trainTicketingServiceServiceDescriptor                = v1.File_tests_go_samples_train_ticketing_v1_ticketing_proto.Services().ByName("TrainTicketingService")
...
// TrainTicketingServiceClient is a client for the
// tests.go.samples.train_ticketing.v1.TrainTicketingService service.
...
// tests.go.samples.train_ticketing.v1.TrainTicketingService service. By default, it uses the
...
// PurchaseTicket calls tests.go.samples.train_ticketing.v1.TrainTicketingService.PurchaseTicket.
...
// ViewReceipt calls tests.go.samples.train_ticketing.v1.TrainTicketingService.ViewReceipt.
...
// ViewAdminDetails calls
// tests.go.samples.train_ticketing.v1.TrainTicketingService.ViewAdminDetails.
...
// RemoveUser calls tests.go.samples.train_ticketing.v1.TrainTicketingService.RemoveUser.
...
// ModifySeat calls tests.go.samples.train_ticketing.v1.TrainTicketingService.ModifySeat.
...
func NewTrainTicketingServiceHandler(svc TrainTicketingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/tests.go.samples.train_ticketing.v1.TrainTicketingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTrainTicketingServiceHandler) PurchaseTicket(context.Context, *connect.Request[v1.PurchaseTicketRequest]) (*connect.Response[v1.PurchaseTicketResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tests.go.samples.train_ticketing.v1.TrainTicketingService.PurchaseTicket is not implemented"))
}
...
func (UnimplementedTrainTicketingServiceHandler) ViewReceipt(context.Context, *connect.Request[v1.ViewReceiptRequest]) (*connect.Response[v1.ViewReceiptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tests.go.samples.train_ticketing.v1.TrainTicketingService.ViewReceipt is not implemented"))
}
...
func (UnimplementedTrainTicketingServiceHandler) ViewAdminDetails(context.Context, *connect.Request[v1.ViewAdminDetailsRequest]) (*connect.Response[v1.ViewAdminDetailsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tests.go.samples.train_ticketing.v1.TrainTicketingService.ViewAdminDetails is not implemented"))
}
...
func (UnimplementedTrainTicketingServiceHandler) RemoveUser(context.Context, *connect.Request[v1.RemoveUserRequest]) (*connect.Response[v1.RemoveUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tests.go.samples.train_ticketing.v1.TrainTicketingService.RemoveUser is not implemented"))
}
...
func (UnimplementedTrainTicketingServiceHandler) ModifySeat(context.Context, *connect.Request[v1.ModifySeatRequest]) (*connect.Response[v1.ModifySeatResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tests.go.samples.train_ticketing.v1.TrainTicketingService.ModifySeat is not implemented"))
}
