...
namespace
{
    ...
    TEST(VectorTestsAddValuesTest, Underflow)
    {
    ...
    TEST(VectorTestsAdvanced, Iteration)
    {
    ...
    TEST(VectorTestsAdvanced, ResizeAndAccess)
    {
    ...
    TEST(VectorTestsAdvanced, InsertAndErase)
    {
    ...
    TEST(VectorTestsAdvanced, SwapAndClear)
    {
    ...
    TEST(VectorTestsAdvanced, EmplaceAndEmplaceBack)
    {
    ...
    TEST(VectorTestsAdvanced, AllMemberFunctions)
    {
